...
# avoid old build problems by removing potentially incorrect old files
	...
	rm -rf qemu_bin.tar.xz qemu_bin_debug.tar.xz qemu_bin
...
package: all
	make DESTDIR="`pwd`/qemu_bin" install
	tar -Jcvf qemu_bin.tar.xz qemu_bin
	rm -rf qemu_bin
	cp -rf x86_64-softmmu/qemu-system-x86_64 qemu-system-x86_64
	tar -Jcvf qemu_bin_debug.tar.xz qemu-bridge-helper qemu-img qemu-io qemu-nbd qemu-system-x86_64
	rm -rf qemu-system-x86_64
